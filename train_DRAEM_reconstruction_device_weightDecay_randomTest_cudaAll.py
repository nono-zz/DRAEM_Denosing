...
if __name__=="__main__":
    ...
    parser.add_argument('--lr', default=0.00001, action='store', type=float)
    ...
    parser.add_argument('--experiment_name', default='DRAEM_Denoising_reject_weightDecay_bs_32', choices=['DRAEM_Denoising_reconstruction, liver, brain, head'], action='store')
