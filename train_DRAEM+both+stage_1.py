...
if __name__=="__main__":
    ...
    parser.add_argument('--experiment_name', default='DRAEM_Augmentation_both_Stage_1', choices=['DRAEM_Denoising_reconstruction, RandomShape_reconstruction, brain, head'], action='store')
    ...
    parser.add_argument('--model', default='DRAEM_reconstruction', choices=['ws_skip_connection', 'DRAEM_reconstruction', 'DRAEM_discriminitive'], action='store')
