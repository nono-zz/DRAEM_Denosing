...
def train_on_device(args, fold_index):
...
if __name__=="__main__":
    ...
    parser.add_argument('--experiment_name', default='DRAEM_Denoising_cross_fold', choices=['DRAEM_Denoising_reconstruction, liver, brain, head'], action='store')
    ...
    for i in range(0, 5):
        train_on_device(args, fold_index = i)
