...
if __name__=="__main__":
    ...
    parser.add_argument('--experiment_name', default='DRAEM_Denoising_reject_weightDecay_detach_wo_ssim_exp_3', choices=['DRAEM_Denoising_reconstruction, liver, brain, head'], action='store')
